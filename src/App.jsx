    ...
    <div style={{display:"flex",flexDirection:"column",gap:16}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"300px minmax(0,1fr)",gap:18,alignItems:"start"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          <div className="card">
            <div style={{fontSize:10,color:ACC,letterSpacing:"1.5px",textTransform:"uppercase",fontWeight:600,marginBottom:14}}>Shared Settings</div>
          ...
          {mode==="findsip"&&(<>
            <div className="card" style={{borderColor:PURP+"40"}}>
              <div style={{fontSize:10,color:PURP,letterSpacing:"1.5px",textTransform:"uppercase",fontWeight:600,marginBottom:14}}>Target</div>
            ...
            <div className="card" style={{borderColor:ACC+"40"}}>
              <div style={{fontSize:10,color:ACC,letterSpacing:"1.5px",textTransform:"uppercase",fontWeight:600,marginBottom:14}}>Lumpsum (optional)</div>
            ...
            <div className="card" style={{borderColor:BLUE+"40"}}>
              <div style={{fontSize:10,color:BLUE,letterSpacing:"1.5px",textTransform:"uppercase",fontWeight:600,marginBottom:14}}>SIP Settings</div>
              <div style={{marginBottom:14}}>
                <div style={{fontSize:10,color:TEXT3,letterSpacing:"1.5px",textTransform:"uppercase",fontWeight:600,marginBottom:7}}>Frequency</div>
